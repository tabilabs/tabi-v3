...
type TestTabiDBAppOpts struct {
}

func (t TestTabiDBAppOpts) Get(s string) interface{} {
	switch s {
	case FlagSCEnable:
...
func TestNewDefaultConfig(t *testing.T) {
	// Make sure when adding a new default config, it should apply to TabiDB during initialization
	appOpts := TestTabiDBAppOpts{}
