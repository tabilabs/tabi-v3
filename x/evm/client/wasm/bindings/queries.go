...
const (
	...
	GetTabiAddressType     EVMQueryType = "evm_query_get_tabi_address"
	SupportsInterfaceType  EVMQueryType = "evm_query_supports_interface"
)

func (q *TabiEVMQuery) GetQueryType() EVMQueryType {
	if q.StaticCall != nil {
	...
	if q.GetTabiAddress != nil {
		return GetTabiAddressType
	}
...
type TabiEVMQuery struct {
	...
	GetTabiAddress               *GetTabiAddressRequest               `json:"get_tabi_address,omitempty"`
...
type GetEvmAddressRequest struct {
	TabiAddress string `json:"tabi_address"`
}

type GetTabiAddressRequest struct {
...
type GetTabiAddressResponse struct {
	TabiAddress string `json:"tabi_address"`
	Associated  bool   `json:"associated"`
}
