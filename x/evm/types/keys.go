...
var (
	EVMAddressToTabiAddressKeyPrefix           = []byte{0x01}
	TabiAddressToEVMAddressKeyPrefix           = []byte{0x02}
...
func EVMAddressToTabiAddressKey(evmAddress common.Address) []byte {
	return append(EVMAddressToTabiAddressKeyPrefix, evmAddress[:]...)
}

func TabiAddressToEVMAddressKey(tabiAddress sdk.AccAddress) []byte {
	return append(TabiAddressToEVMAddressKeyPrefix, tabiAddress...)
}
