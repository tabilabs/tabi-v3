...
import (
	...
	github_com_tabi_protocol_tabi_chain_x_evm_derived "github.com/tabilabs/tabi-v3/x/evm/derived"
...
type MsgEVMTransaction struct {
	...
	Derived *github_com_tabi_protocol_tabi_chain_x_evm_derived.Derived `protobuf:"bytes,2,opt,name=derived,proto3,customtype=github.com/tabilabs/tabi-v3/x/evm/derived.Derived" json:"derived,omitempty"`
}
