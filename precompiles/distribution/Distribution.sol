...
interface IDistr {
    ...
    /// @dev The caller must have a valid associated Tabi address
    ...
    /// @param validator The validator's Tabi address (e.g., "tabivaloper1...")
    ...
    /// @param validators Array of validator Tabi addresses
    ...
    /// @param validator The validator's Tabi address (must match caller's validator)
    ...
    struct Coin {
        ...
        uint256 decimals;
        /// @notice Token denomination (e.g., "atabi", "uatom")
        string denom;
    }
    ...
    struct Reward {
        ...
        Coin[] coins;
        /// @notice The validator's Tabi address that generated these rewards
