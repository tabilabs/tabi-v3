...
func GetAddressesFromPubkeyBytes(pubkey []byte) (common.Address, sdk.AccAddress, cryptotypes.PubKey, error) {
	...
	tabiPubkey := PubkeyBytesToTabiPubKey(pubkey)
	tabiAddr := sdk.AccAddress(tabiPubkey.Address())
	return evmAddr, tabiAddr, &tabiPubkey, nil
}
...
func PubkeyBytesToTabiPubKey(pub []byte) secp256k1.PubKey {
